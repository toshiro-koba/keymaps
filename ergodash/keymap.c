...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Ctrl |   A  |   S  |   D  |   F  |   G  |   `  |                    |   6  |   H  |   J  |   K  |   L  |   ;  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Space|                    | Enter|   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | LOWER|  ALt |  GUI |      ||||||||   [  | Space|      ||||||||      | Enter|   ]  ||||||||      |      | Bksp | LOWER|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,  KC_4, KC_5,    KC_NO,                       KC_NO,  KC_7,    KC_8, KC_9,    KC_0,   KC_MINS, KC_EQL, \
    KC_TAB,  KC_Q,    KC_W,    KC_E,  KC_R, KC_T,    KC_NO,                       KC_NO,  KC_Y,    KC_U, KC_I,    KC_O,   KC_P,    KC_BSLS, \
    KC_LCTL, KC_A,    KC_S,    KC_D,  KC_F, KC_G,    KC_GRV,                      KC_6,   KC_H,    KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,  KC_V, KC_B,    KC_SPC,                      KC_ENT, KC_N,    KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
    LOWER,   KC_LALT, KC_LGUI, KC_NO,       KC_LBRC, KC_SPC, KC_NO,        KC_NO, KC_ENT, KC_RBRC,       KC_NO,   KC_NO,  KC_BSPC, LOWER  \
  ),
   ...
   * |      | Prev | Play | Next |      |      |      |                    |      |      |      |      |      |      |      |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Caps |Vol Do|Vol Up| Mute |      |      |      |                    |  F6  | Left | Down |  Up  | Right|      |      |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |                    |      |      |      |      |      |      |      |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | LOWER|      |      |      ||||||||      |      |      ||||||||      |      |      ||||||||      |      |      | LOWER|
   ...
   */
  [_LOWER] = LAYOUT(
    KC_NO,   KC_F1,   KC_F2,  KC_F3,   KC_F4, KC_F5, KC_NO,                      KC_NO, KC_F7,   KC_F8,   KC_F9, KC_F10,   KC_F11, KC_F12,  \
    KC_NO,   KC_MPRV,KC_MPLY, KC_MNXT, KC_NO, KC_NO, KC_NO,                      KC_NO, KC_NO,   KC_NO,   KC_NO, KC_NO,    KC_NO,  KC_NO, \
    KC_CAPS, KC_VOLD,KC_VOLU, KC_MUTE, KC_NO, KC_NO, KC_NO,                      KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_NO,  KC_NO, \
    KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_NO, KC_NO, KC_NO,                      KC_F6, KC_NO,   KC_NO,   KC_NO, KC_NO,    KC_NO,  KC_NO, \
    LOWER,   KC_NO,   KC_NO,  KC_NO,          KC_NO, KC_NO, KC_NO,        KC_NO, KC_NO, KC_NO,            KC_NO, KC_NO,    KC_NO,  LOWER   \
  ),
